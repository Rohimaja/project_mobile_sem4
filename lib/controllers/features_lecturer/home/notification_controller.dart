...
import 'package:stipres/services/lecturer/notification_service.dart';
import 'package:timezone/timezone.dart' as tz;

class LecturerNotificationController extends GetxController {
  ...
  final LecturerNotificationService lecturerNotificationService =
      LecturerNotificationService();
  ...
  void fetchNotifications() async {
    try {
      ...
      final result =
          await lecturerNotificationService.tampilNotifikasi(dosenId);
