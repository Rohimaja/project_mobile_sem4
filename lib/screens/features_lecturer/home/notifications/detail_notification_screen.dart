...
class DetailNotificationScreen extends StatelessWidget {
  ...
  String _generateDetailMessage(NotificationModel notif) {
    ...
    switch (notif.type) {
      case NotificationType.presensiBerhasil:
        return "Hai, $user!\n\n"
            "Anda telah menambahkan presensi pada tanggal $tanggal, pukul $jam. "
            "Presensi yang Anda tambahkan telah tercatat untuk mata kuliah $matkul.";
      case NotificationType.presensiGagal:
        return "Hai, $user!\n\n"
            "Kami mendeteksi kendala pada penambahan presensi Anda tanggal $tanggal, pukul $jam "
      ...
      case NotificationType.presensiAkanHabis:
        return "Hai, $user!\n\n"
            ...
            "Segera perpanjang batas waktu presensi.";
      case NotificationType.pengumuman:
        return "Hai, $user!\n\n"
            "${notif.message}";
    }
