...
class StudentNotificationService extends GetxService {
  ...
  Future<BaseResponse<List<NotificationModel>>> tampilNotifikasi(
    ...
    try {
      ...
      final url = Uri.parse("$_baseUrl/getNotification/mahasiswa/$mahasiswaId");
      log.d(url);
      ...
      if (response.statusCode == 401) {
        ...
        if (refreshSuccess) {
          return await tampilNotifikasi(mahasiswaId);
        }
      }
